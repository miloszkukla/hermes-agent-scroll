...
from ._runtime import ScrollRuntime
from ._runtime.index import EvictionIndex, Leaf
from ._runtime.types import ExecutionResult, LogEntry
...
class ScrollContextManager:
    ...
    def protocol_prompt(self) -> str:
        ...
        """
        from .prompts import protocol_prompt
